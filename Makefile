...
build-web-and-tasks:
	DOCKERFILE_VERSION=.dev docker-compose build --build-arg home=/home/user --build-arg user=user --build-arg group=user --build-arg uid=$(shell id -u) --build-arg gid=$(shell id -g) web tasks
