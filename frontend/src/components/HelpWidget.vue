          ...
          <div class="content">
            ...
            <template v-if="id === 'basic-streaming-on-pricing-page'">
              ...
              <div>
                <i18next :translation="$t('Learn more about {localizedDom}')">
                  <template #localizedDom>
                    <a :href="getDocLink('/user-guides/webcam-streaming-for-human-eyes/')" target="_blank">{{$t("the differences between the Premium Streaming and the Basic Streaming")}} <i class="fas fa-external-link-alt"></i></a>
                  </template>
                </i18next>
            ...
            <template v-if="id === 'detective-hours-free-plan-on-pricing-page'">
              ...
              <p>
                {{$t("Learn more about")}}
                <a
                  :href="getDocLink('/user-guides/how-does-detective-hour-work/')"
                  target="_blank"
                  >{{ $t("how the AI Detection Hour works ") }}<i class="fas fa-external-link-alt"></i
                ></a>
              </p>
            ...
            <template v-if="id === 'premium-streaming-on-pricing-page'">
              ...
              <p>
                {{$t("Learn more about")}}
                <a
                  :href="getDocLink('/user-guides/webcam-streaming-for-human-eyes/')"
                  target="_blank"
                  >{{$t("the differences between the Premium Streaming and the Basic Streaming")}}
                  <i class="fas fa-external-link-alt"></i
                ></a>
            ...
            <template v-if="id === 'tunneling-free-plan-on-pricing-page'">
              ...
              <p>
                {{$t("Learn more about")}}
                <a :href="getDocLink('/user-guides/octoprint-tunneling/')" target="_blank"
            ...
            <template v-if="id === 'thumbnail-setup-guide'">
              <p>
                <a :href="getDocLink('/user-guides/enable-gcode-thumbnails/')" target="_blank"
