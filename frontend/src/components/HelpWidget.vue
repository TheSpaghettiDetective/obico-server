        ...
        <div v-show="show" ref="widget" class="widget" :class="[xDirection, yDirection]">
          ...
          <div class="content">
            ...
            <template v-if="id === 'filament-change-on-notification-preferences'">
              <i>
                <ul>
                  ...
                  <li>The {{$t('name')}} plugin 1.8.11 or higher</li>
                </ul>
              </i>
              <h3>Filament Runout Notifications</h3>
              <p>
                Host_action_commands must be enabled in your firmware to make it possible for your
                filament runout sensor to communicate with OctoPrint and the {{$t('name')}} app. If you
                enable action commands in your firmware, then the filament runout sensor can work
                properly and the {{$t('name')}} app can notify you when the filament runs out. Unfortunately,
            ...
            <template v-if="id === 'filament-used-may-be-incorrect'">
              ...
              <p>
                G-code files uploaded to your {{$t('name')}} account before upgrading to {{$t('name')}} for OctoPrint
                version 2.3.0 or {{$t('name')}} for Klipper version 1.2.0 do not include filament usage data.
              </p>
              <p><strong>To ensure accurate filament usage and other statistics:</strong></p>
              <ul>
                <li>
                  Upload G-code files and start prints directly through {{$t('name')}} instead of
                  OctoPrint/Klipper.
                </li>
                <li>
