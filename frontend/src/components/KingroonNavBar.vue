  ...
  <div>
    ...
    >
      <b-container class="p-0">
        <b-navbar-brand href="https://kingroon.com/">
          <SyndicateAwareSVG href="#svg-kingroon-logo-compact" width="100" height="30" />
        </b-navbar-brand>
