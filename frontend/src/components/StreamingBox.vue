  ...
  methods: {
    ...
    onInfoClicked() {
      ...
      this.$swal.Prompt.fire({
        ...
        html: `
          <p>Because you are now on the <a target="_blank" href="https://www.obico.io/docs/user-guides/upgrade-to-pro/?source=basic_streaming">${this.$t('name')} Cloud Free plan</a>:</p>
          <ul>
