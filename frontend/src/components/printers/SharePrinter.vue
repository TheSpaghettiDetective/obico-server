<template>
  <div>
    ...
    <div v-if="!isProAccount">
      ...
      <p>
        <a  :href="getDocLink('/user-guides/upgrade-to-pro#why-cant-the-detective-just-work-for-free-people-love-free-you-know')">
              ...
              <small>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <a :href="getDocLink('/user-guides/printer-feed-sharing/')"
