<template>
  <div>
    ...
    <div v-if="!isProAccount">
      ...
      <p><a
          href="https://www.obico.io/docs/upgrade-to-pro#why-cant-the-detective-just-work-for-free-people-love-free-you-know">Running
          ...
          <em class="text-muted">
            <small>
              ...
              <ul>
                ...
                <li>Anyone with this shareable link will be able to see your printer feed. <a href="https://www.obico.io/docs/printer-feed-sharing/">Learn more about what
                    they can see.</a></li>
              </ul>
            </small>
          </em>
