<template>
  <div>
    <div class="control-panel">
      ...
      <a role="button" class="btn btn-outline-primary" href="/g_code_folders/" title="Upload more G-Code">
    ...
    <div v-else>
      <p class="text-center font-weight-bold my-3">No G-Codes yet. You can upload them <a href="/g_code_folders/">here</a>.</p>
    </div>
  </div>
</template>
