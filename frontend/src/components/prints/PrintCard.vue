  ...
  methods: {
    ...
    showVideoArchivedDescription(event) {
      ...
      this.$swal.Prompt.fire({
        ...
        html: `
          <p>Time-lapse videos older than 6-months are deleted from the ${this.$t('name')} app server as they are rarely needed and cost significant amount to store in the cloud.</p>
