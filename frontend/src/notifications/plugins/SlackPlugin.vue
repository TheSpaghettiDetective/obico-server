  ...
  >
    <template #header>
      <div v-if="setupCompleted" class="mb-4">
        <p class="lead">
          <i class="far fa-check-circle text-success"></i>&nbsp;&nbsp;Obico Messenger has been
        ...
        <br />
        <p>
          1. Make sure Obico Messenger is added to the channels you want the notifications to be
          sent to.
        </p>
        <img
          class="mw-100"
      ...
      <div v-else>
        <p class="lead">Click the button below to add the Obico Slack App into your workspace:</p>
        <a
    ...
    <template #footer>
      <div v-if="setupCompleted">
        ...
        <br />
        <p>
          Q: How do I remove the Obico Slack App from a slack channel so that it won't send
        ...
        />
        <br /><br />
        <p>Q: How do I remove the Obico Slack App from the entire workspace?</p>
        <p>
