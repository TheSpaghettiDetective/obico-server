        ...
        <div class="text-muted">
          <i18next :translation="$t('Monthly data usage ({localizedDom})')">
            <template #localizedDom>
              <a :href="getDocRoot('/user-guides/octoprint-tunneling/#is-octoprint-tunneling-free-to-all-users')" target="_blank">{{$t("Resets in {daysUntilReset} days",{daysUntilReset})}}</a>
            </template>
          </i18next>
        </div>
      ...
      this.$swal.Prompt.fire(
        {
          ...
          <div class="p-1">
            <a target="_blank" href="${getDocRoot('/user-guides/octoprint-tunneling/#is-octoprint-tunneling-free-to-all-users')}">
