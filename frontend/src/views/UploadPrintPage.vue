      ...
      <b-container>
        <b-row class="justify-content-center">
          <b-col lg="8" class="text-center">
            ...
            <p class="pb-2">Upload time-lapse videos to test {{$t('name')}}'s AI failure detection.</p>
            <vue-dropzone
              id="dropzone"
              class="upload-box"
            ...
            <div v-show="uploaded" class="pt-5">
              <div id="tl-uploaded">
                ...
                <div class="py-2 text-center">
                  <div class="py-2">
                    The {{$t('name')}} Server is running failure detection on the time-lapse video(s) you
                    uploaded.
                  </div>
