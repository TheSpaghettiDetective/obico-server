        ...
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
            ...
            <a class="dropdown-item" :href="octoPrintTunnelUrl()">
              <svg class="menu-icon tunneling" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 346.26 368.59">
                <path class="tone-1"
                  d="M336,358.66V172.06A162.88,162.88,0,0,0,173.13,9.18h0A162.88,162.88,0,0,0,10.24,172.06v186.6l64-58V175.09a98.91,98.91,0,0,1,98.91-98.91h0A98.91,98.91,0,0,1,272,175.09V300.64l64,58" />
                <path class="tone-2"
                  d="M253.53,221.06c0-.08-.06-.21-.13-.4-1.17-3.88-9.32-30.61-30.45-41.54-22-11.36-51.1-15.86-78.91,13.55C108.19,230.59,148.71,272,152,297.38H107C85.92,257.57,88.1,221.43,98.52,196.8,111,167.41,153,137.72,196.58,148.63,271.54,167.39,253.53,221.06,253.53,221.06Z" />
                <path class="tone-2"
                  d="M253.53,221.06c-.46-1.17-1.08-2.77-1.66-3.91a25.4,25.4,0,0,0-1.14-2.49s-.31-.82-.32-.83c-2.82-4.71-4.77-8.71-9.23-12.47a62.73,62.73,0,0,0-12.36-8.16c-.55-.28-1.1-.56-1.65-.8-16.18-7.65-36.17-9.07-53.28.27-20.4,11.15-18.53,28-11.84,41.57l0,.08a69.13,69.13,0,0,0,6.52,10.5s0,0,0,0a75.74,75.74,0,0,0,5.27,6.38c7.22,7.78,13.84,21.48,18.38,32.29,2.56,6.11,4.46,11.31,5.39,14H153.39a.22.22,0,0,0,0-.11c-1.27-24.48-43.55-65.71-7.88-103.44,27-28.52,55.22-24.16,76.54-13.15,20.44,10.58,30,36,31.37,39.87C253.47,220.85,253.5,221,253.53,221.06Z" />
              </svg>
              Tunneling
            </a>
...
export default {
  ...
  methods: {
    ...
    toDuration (seconds, isPrinting, isTotal = false) {
      if (seconds == null || seconds == 0) {
        ...
        return {
          ...
          seconds: s,
          showSeconds: (h==0 && m==0),
          endTime: isTotal ? moment().add(seconds, 'seconds').format('HH:MM') : null
        }
      }
    },
