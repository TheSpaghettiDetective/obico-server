...
def send_discord_notification(printer, text, color, webhook_url, image_url=None):
    ...
    embed.set_author(name="Click Here to Examine.", url=site.build_full_url('/printers/'), icon_url="https://github.com/TheSpaghettiDetective/TheSpaghettiDetective/raw/master/frontend/static/img/logo-square.png")
    embed.set_timestamp()
