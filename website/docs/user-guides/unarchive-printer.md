...
* If your account is on the AI Premium plan, you can add unlimited number of printers to your plan with as low as $2 per printer per month.
...
For instance, if you have subscribed for 3 printers in your AI Premium plan, and you already have 2 active printers, you can still un-archive up to 1 printer.
...
* [Upgrade to the AI Premium plan](https://app.obico.io/ent_pub/pricing/) if you are currently on the Free plan.
* If you are already on the AI Premium plan, you can change the number of printers on [your subscription page](https://app.obico.io/user_preferences/subscription/).
