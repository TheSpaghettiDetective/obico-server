...
When this happens, you'll have the laggy, 1-frame-per-10-seconds streaming. And the plugin will pop up this warning message to alert you. See [0.1 FPS troubleshooting](/docs/user-guides/webcam-feed-is-not-showing/#0.1-fps) to figure out why.
